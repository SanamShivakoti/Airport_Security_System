...
from Airport_Security.views import UserRegistrationView, LoginUserView, AdminProfileView, OTPVerifiedPasswordResetView, UserView, UpdateUserView, DeleteUserView,VerifyOtpView, SendOtpResetEmailView, FilterUserView
urlpatterns = [
