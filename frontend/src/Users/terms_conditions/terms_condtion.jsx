      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-base text-justify">
          ...
          <p className="mb-6">
            ...
            <br />- Users must adhere to all applicable laws and regulations
            governing airport security. Users are responsible for ensuring the
          ...
          <p className="mb-6">
            ...
            passport information, for security purposes only.
            ...
            Users must ensure the confidentiality and security of all data
